...
const styles = {
  autogrow: 'flex-grow',
  header: 'h-[746px] bg-gradient-to-br from-white to-blue-300 pt-8 px-16',
  ...
  linkItem: "capitalize cursor-pointer",
  ...
  btnSecondary: "w-64 bg-blue-200 text-blue-500 font-bold rounded-lg p-4",
  btnOutlined: "transition-colors text-blue-500 hover:bg-blue-100 border border-blue-500 rounded p-4",
  wrapper: "mt-20 flex items-center justify-between",
  brandTitle: 'text-[3.8em] text-darkBlue font-bold leading-[60px]',
  brandDescription: "text-lg text-gray-500",
  btnGroup: "flex gap-8",
  actionBtn: "flex-none w-auto px-8 py-5 capitalize font-semibold"
}
